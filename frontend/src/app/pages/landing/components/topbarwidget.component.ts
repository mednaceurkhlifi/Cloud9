...
@Component({
    ...
    template: `<a class="flex items-center" href="#">
            ...
            <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">Queute</span>
        </a>
        ...
        <div class="items-center bg-surface-0 dark:bg-surface-900 grow justify-between hidden lg:flex absolute lg:static w-full left-0 top-full px-12 lg:px-0 z-20 rounded-border">
            <ul class="list-none p-0 m-0 flex lg:items-center select-none flex-col lg:flex-row cursor-pointer gap-8">
                ...
                <li>
                    <a (click)="router.navigate(['/postList'])" pRipple class="px-0 py-4 text-surface-900 dark:text-surface-0 font-medium text-xl">
                        <span>Forum</span>
                    </a>
                </li>

                <li>
                    <a (click)="router.navigate(['/organisation'])" pRipple class="px-0 py-4 text-surface-900 dark:text-surface-0 font-medium text-xl">
