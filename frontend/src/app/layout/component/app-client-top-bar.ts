...
@Component({
    ...
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, AppConfigurator,InputTextModule,ButtonModule,CardModule,MenuModule,RippleModule],
        ...
        <div class="layout-topbar-actions">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <button type="button" class="layout-topbar-action" routerLink="/auth/profile">
                        <i class="pi pi-user"></i>
                        <span>Profile</span>
                        <div class="layout-topbar-actions p-d-flex p-ai-center">
...
export class AppClientTopBar implements OnInit {
    items!: MenuItem[];
